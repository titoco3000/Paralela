...
//digitos calculados, deve ser um numero impar
#define N_DIGITS 1000001

//extremamente ineficiente (mas é só pra debug)
...
/*Prrenche uma unica casa do vetor com 1*/
    ...
    if(arquivo){
        ...
        if (malloc_result == cudaSuccess)
        {
            ...
            */
            ...
            fprintf(stderr,cudaGetErrorString(malloc_result));
        }       
    }
}
